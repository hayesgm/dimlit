...
export const scene = () => (
  <a-scene>
    ...
    <a-plane material={{ color: 'blue' }} width={20} height={20} position={{ x: 0, y: 0, z: 0 }} rotation={{ x: -90, y: 0, z: 0 }} />
    <a-entity gltf-model="#hoop" scale={{ x: 0.01, y: 0.01, z: 0.01 }} rotation={{ x: 0, y: 180, z: 0 }} position={{ x: 0, y: 0, z: -3 }} />
    <a-entity gltf-model="#ball" scale={{ x: 0.01, y: 0.01, z: 0.01 }} position={{ x: 0, y: 0.3, z: -2 }} />
